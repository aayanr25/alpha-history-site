...
// .wrangler/tmp/pages-VF986J/functionsWorker-0.01935164671865164.mjs
...
async function onRequest3(context) {
  ...
  const col = /* @__PURE__ */ __name2((name) => header.indexOf(name), "col");
  const idx = {
    order: col("order"),
  ...
  const cell = /* @__PURE__ */ __name2((row, i) => i >= 0 && row[i] != null ? String(row[i]).trim() : "", "cell");
  const entries = [];
...
// .wrangler/tmp/bundle-WzNSB4/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-WzNSB4/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.01935164671865164.js.map
